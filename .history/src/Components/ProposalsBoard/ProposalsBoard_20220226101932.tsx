      ...
      <table className="table-auto border-collapse border border-slate-400">
        <thead>
          <tr>
            ...
            <th className="border border-slate-300">vote count</th>
            <th className="border border-slate-300">vote!</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            ...
            <td>
              <button className="bg-teal-400 hover:bg-teal-600 text-white  py-1 px-3 rounded mx-2 border border-slate-300">
                Vote
              </button>
            </td>
          </tr>
