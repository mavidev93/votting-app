...
function ProposalsBoard() {
  ...
  useEffect(() => {
    ...
    async function getProposals() {
      ...
      const proposalsLength = contract.getProposalsLength();

      //create an array with length of proposals and map throgh it  
     const proposalsArr = Array.apply(null, Array(5)).map(async(un,i)=>{
       const proposal = contract.getProposal[i];
       return proposal
     })
