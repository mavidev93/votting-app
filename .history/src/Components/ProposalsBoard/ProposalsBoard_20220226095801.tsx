  ...
  return (
    <div>
      <table className="table-auto">
        ...
        <tbody>
          <tr>
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore ullam molestiae temporibus dolorem. Eius eaque sunt, dolor explicabo exercitationem consequuntur ab tempore velit alias, fugiat aliquam, incidunt unde hic voluptate.
          </tr>
