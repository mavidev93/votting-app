  ...
  useEffect(() => {
    ...
    async function getProposals() {
      ...
      const proposalArr = proposalRes.map(proposal=>{
        const { proposedBy, voteCount, proposalText } = proposal;
        return {proposedBy, voteCount:voteCount.toString(), proposalText}
      })
  ...
  return (
    <div>
      <table className="table-auto">
        ...
        <tbody>
    { proposals && proposals?.map(p=><div>p.proposalText</div>)}
