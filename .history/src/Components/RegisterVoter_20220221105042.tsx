...
function RegisterVoter() {
  ...
  const handleRegister =async (event) => {
    ...
    if (ethers.utils.isAddress(addressVal)) {
      ...
      const votingProposalsWithSigner = new ethers.Contract(votingProposalsAddress,VotingProposals.abi,signer);
      const recept = await votingProposalsWithSigner.addVoter(addressVal)
