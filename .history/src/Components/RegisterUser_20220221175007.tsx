...
function RegisterUser() {
  ...
  const handleRetriveUser = ()=>{
    const provider = new ethers.providers.Web3Provider(window.ethereum)
    const votingProposalsWithProvider = new ethers.Contract(votingProposalsAddress,VotingProposals.abi,provider);
    const user = votingProposalsWithProvider.retriveUser(0x3C44CdDdB6a900fa2b585dd299e03d12FA4293BC)
  }
